...
public abstract class BaseDirective implements TemplateDirectiveModel {
	...
	protected String getString(String name, Map<String, TemplateModel> params) throws Exception {
		return FreemarkerUtils.getString(name, params);
	}
	
	protected Object getObject(String name, Map<String, TemplateModel> params) throws Exception {
