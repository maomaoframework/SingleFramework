...
public class CloudMultipartHttpServletRequest extends StandardMultipartHttpServletRequest {
	...
	public CloudMultipartHttpServletRequest(HttpServletRequest request) {
		super(request);
		this.parameters = new HashMap();
	}

	public CloudMultipartHttpServletRequest(HttpServletRequest request, MultiValueMap multipartFiles, Map multipartParameters) {
		this(request);
